...
public class HomePage extends BaseWebPage {
	...
	public HomePage(WebDriver driver) 
    {
	 ...
	 public LoginPage logOffFromApp()
	    {
		 	clickElement(homePageObjRepo, "Logout",false, 0, "","Logout field in Home Page not visible");
		 ...
		 try {
			 if(isElementDisplayed(homePageObjRepo, "Logout",  false, 0, "")){
					return true; 
					 ...
					 waitForElementVisible(homePageObjRepo, "Logout",  false, 0, "","[IGNORE this ERROR message]Verifying whether App is logged in");
					 return true;
				 }
